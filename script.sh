...
log_file="${download_path}/.audio-video-downloader-by-alham.log"
...
help() {
    ...
    echo -e "\tTo successfully use this script, you have to have '${white}yt-dlp${green}' and '${white}xclip${green}' installed if you need to copy a URL from the clipboard."
